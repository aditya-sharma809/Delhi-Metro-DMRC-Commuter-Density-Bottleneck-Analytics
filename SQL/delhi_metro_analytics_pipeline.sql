...
-- COMPLETE SQL PIPELINE (BIGQUERY DATA WAREHOUSE)
-- Author: Aditya Sharma
-- =============================================================================


-- =============================================================================
-- SECTION 1: DATA CLEANING & STANDARDIZATION (PHASE 11)
-- Description: Clean raw staging table, trim whitespaces, convert types,
--              impute nulls, and derive baseline categorical surge features.
-- =============================================================================
...
-- =============================================================================
-- SECTION 2: ADVANCED ANALYTICAL QUERIES (PHASE 12)
-- =============================================================================

-- -----------------------------------------------------------------------------
-- Query 2.1: CTE + JOIN + HAVING (Major Bottleneck Stations)
-- Goal: Identify origin hubs handling >5,000 trips sorted by passenger volume.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Query 2.3: Subquery Analysis (Percentage Revenue Contribution)
-- Goal: Calculate exact share of total revenue per Ticket Type.
-- -----------------------------------------------------------------------------
SELECT 
    Ticket_Type_Clean,
...
-- Goal: Calculate running totals and moving average trends for ridership.
-- -----------------------------------------------------------------------------
WITH Daily_Stats AS (
    SELECT 
        Date,
...
-- =============================================================================
-- SECTION 3: CONSOLIDATED MASTER TABLE (PHASE 13)
-- Description: Create a unified summary master table optimized for BI tools
...
-- =============================================================================
-- SECTION 4: ADVANCED FEATURE ENGINEERING (PHASE 14)
-- Description: Derive machine learning & business metrics for deep analytics.
-- =============================================================================
